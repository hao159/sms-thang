...
var App = function() {
    ...
    var templateOptions = function() {
        ...
        if (cookies) {
            themeColorCke = getCookie('optionThemeColor') ? getCookie('optionThemeColor') : false;
            ...
            if (themeColorCke) {
                if (themeColorCke === 'default') {
                    ...
                    if (themeLink.length) {
                        themeLink.attr('href', '/public/'+themeColorCke);
                    } else {
                        $('link[href="/public/css/themes.css"]')
                            .before('<link id="theme-link" rel="stylesheet" href="/public/' + themeColorCke + '">');
        ...
        $('a', colorList).click(function(e){
            ...
            if (themeColor === 'default') {
                ...
                if (themeLink.length) {
                    themeLink.attr('href', '/public/'+themeColor);
                } else {
                    $('link[href="/public/css/themes.css"]').before('<link id="theme-link" rel="stylesheet" href="/public/' + themeColor + '">');
                    themeLink = $('#theme-link');
                }
            }
            ...
            if (cookies) {
                setCookie('optionThemeColor', themeColor, cookie_exp);
            }
        });
		...
		let pageStyle = getCookie('pageStyle') ? getCookie('pageStyle') : 'style-default';
        if (pageStyle === 'style-alt') {
        ...
        optMainStyle.click(function() {
            ...
            optMainStyleAlt.removeClass('active');
			setCookie('pageStyle', 'style-default', cookie_exp)
        });
        ...
        optMainStyleAlt.click(function() {
            ...
            $(this).addClass('active');
            optMainStyle.removeClass('active');
			setCookie('pageStyle', 'style-alt', cookie_exp)
        });

        /* Header options */
        var optHeaderDefault    = $('#options-header-default');
        var optHeaderInverse    = $('#options-header-inverse');
		let headerStyle = getCookie('headerStyle') ? getCookie('headerStyle') : 'navbar-default';

		if (headerStyle === 'navbar-default'){
        ...
        optHeaderDefault.click(function() {
            ...
            $(this).addClass('active');
            optHeaderInverse.removeClass('active');
			setCookie('headerStyle', 'navbar-default', cookie_exp);
        });
        ...
        optHeaderInverse.click(function() {
            ...
            $(this).addClass('active');
            optHeaderDefault.removeClass('active');
			setCookie('headerStyle', 'navbar-inverse', cookie_exp);
        });
    };
